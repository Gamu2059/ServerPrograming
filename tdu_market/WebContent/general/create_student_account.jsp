				...
				<div class="input_field_ver2">
					<div class="input_content_img">
						...
						<div>
							<label>
								<h2>アイコン</h2>
							</label> <input id="iconFile" type="file" name="iconImageURL" /> <label>
								<br /> 画像形式：.png .jpg<br /> 画像のサイズ：400px*400px未満
							</label>
						</div>
						<!-- アイコン画像のプレビュー -->
						<script>
					...
					<div class="input_content">
						...
						<input type="password" id="password" name="nonHashedPassword1"
							placeholder="パスワード" /> <input type="password" id="password"
							name="nonHashedPassword2" placeholder="確認用" />
					</div>
					<div class="input_content">
						<h2>自己紹介</h2>
