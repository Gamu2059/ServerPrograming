		...
		<article>
			...
			<div class="item_for_center">
				<div class="list_content">
					...
					<input type="hidden" name="whereFromToItemPage"
						...
						<table id="itemList">
							...
							<tbody class="list" id="list_content">
								...
								%>
								<tr class="exhibitId">
									<th class="check_column1"><input type="checkbox"
										name="itemIDs" value="<%=item.getItemID()%>" />
									</th>
					...
					<script>
						var options = {
							valueNames : [ 'item_column1', 'item_column2',
									'item_column3', 'item_column4',
									'item_column5' ]
						};
						var itemList = new List('itemList', options);
						itemList.sort('item_column1', {
							order : 'asc'
						});
					...
					<form name="select_item"
						action="<%=ServletPath.ManagerReferItemPage%>" method="get">
						<input type="hidden" name="whereFromToItemPage"
							value="fromItemList">
					</form>
					<!-- テーブル要素クリック -->
