...
<body>
	<footer>
		...
		<nav class="footer_menu">
			...
			<div>
				<ul>
					<li><form action="<%=ServletPath.ReferItemListPage%>"
							method="post">
							<input type="hidden" name="oldestDate " value=""> <input
								type="hidden" name="itemNameKeyword " value=""> <input
								type="hidden" name="condtion " value=""> <input
					...
					<li><form action="<%=ServletPath.SearchItemPage%>"
							method="get">
							<button type="submit">
								<a>商品検索</a>
							</button>
			...
			<div>
				<form action="<%=ServletPath.ReferMessageBoxListPage%>"
					method="post">
					<button type="submit">
						<a>メッセージ一覧</a>
					</button>
		...
		<div class="team_name">
			東京電機大学 千住キャンパス 未来科学部 情報メディア学科<br> Team.YAMAGAMI
		</div>
	</footer>
